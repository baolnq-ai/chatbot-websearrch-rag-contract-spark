...
- `RAG_INPUT_TOKEN_BUDGET=6144`
- `RAG_OUTPUT_TOKEN_BUDGET=2048`
- `RAG_FILE_CONTEXT_TOKEN_BUDGET=4096`
- `RAG_HISTORY_TOKEN_BUDGET=1024`
- `RAG_SELECTED_PATH_TOKEN_BUDGET=6144`
