...
Base URL: `http://localhost:6105/api/v1`
...
```bash
curl -X POST http://localhost:6105/api/v1/embed \
...
```bash
curl -X POST http://localhost:6105/api/v1/rerank \
  -H "Content-Type: application/json" \
...
Server chạy tại: **http://localhost:6105**

Swagger UI: **http://localhost:6105/docs**
